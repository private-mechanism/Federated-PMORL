...
class MetaAgent(object):
    ...
    def __init__(self, model, args, is_train=False):
        ...
        # self.evaluate_episode_num = 10
        # self.evaluate_episode_maxstep = 100
...
################non-terminal indexes
    ...
    def learn(self):
        if len(self.trans_mem) > self.batch_size:
            ...
            return self.model, self.model_, loss
        return self.model, self.model_, 0.0
    ...
    # def __evaluate(self, preference):
    #     """
